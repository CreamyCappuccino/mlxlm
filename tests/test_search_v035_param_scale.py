...
class TestSearchStateParamScale:
    ...
    def test_search_state_param_scale_fields(self):
        """Test SearchState has param_scale and param_compare fields."""
        state = SearchState()
        assert hasattr(state, 'param_scale')
        assert hasattr(state, 'param_compare')
        assert state.param_scale is None
        assert state.param_compare == "eq"
    ...
    def test_search_state_param_compare_values(self):
        """Test param_compare accepts eq, lt, gt."""
        state = SearchState()
        ...
        state.param_compare = "lt"
        assert state.param_compare == "lt"

        state.param_compare = "gt"
        assert state.param_compare == "gt"
...
class TestParamScaleEdgeCases:
    ...
    def test_search_state_param_scale_none_vs_default(self):
        ...
        state.param_scale = None
        assert state.param_scale is None
        assert state.param_compare == "eq"  # Compare should stay the same
